...
(function(factory) {
    ...
    */
    ...
    GridStackEngine.prototype.addNode = function(node, triggerAddEvent) {
        ...
        // disable _fixCollisions feature to allow overlap
        ...
        if (!self.opts.staticGrid && self.opts.acceptWidgets) {
            ...
            this.dd
                ...
                .on(self.container, 'dropover', function (event, ui) {
                    ...
                    var defaultWidthHeight = el.data('gs-default-w-h');
                    var maxWidth = el.data('gs-max-width');
                    var maxHeight = el.data('gs-max-height');
                    var minWidth = el.data('gs-min-width');
                    var minHeight = el.data('gs-min-height');
                    if (defaultWidthHeight != null && defaultWidthHeight != "") {
                        node.width = parseInt(defaultWidthHeight.split(",")[0]);
                        node.height = parseInt(defaultWidthHeight.split(",")[1]);
                    }
                    if (maxWidth != null && maxWidth != "") {
                        node.maxWidth = parseInt(maxWidth);
                    }
                    if (maxHeight != null && maxHeight != "") {
                        node.maxHeight = parseInt(maxHeight);
                    }
                    if (minWidth != null && minWidth != "") {
                        node.minWidth = parseInt(minWidth);
                    }
                    if (minHeight != null && minHeight != "") {
                        node.minHeight = parseInt(minHeight);
                    }
